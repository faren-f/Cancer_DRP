...
WholeGenes_Lasso_AUC = sum(WholeGenes_Lasso$AUC)
Landmark_Lasso_AUC = sum(Landmark_Lasso$AUC)
Drug_Pathways_Lasso_AUC = sum(Drug_Pathways_Lasso$AUC)
TF_activity_Lasso_AUC = sum(TF_activity_Lasso$AUC)
Pathway_activity_Lasso_AUC = sum(Pathway_activity_Lasso$AUC)

WholeGenes_ENet_AUC = sum(WholeGenes_ENet$AUC)
Landmark_ENet_AUC = sum(Landmark_ENet$AUC)
Drug_Pathways_ENet_AUC = sum(Drug_Pathways_ENet$AUC)
TF_activity_ENet_AUC = sum(TF_activity_ENet$AUC)
Pathway_activity_ENet_AUC = sum(Pathway_activity_ENet$AUC)

WholeGenes_RF_AUC = sum(WholeGenes_RF$AUC)
Landmark_RF_AUC = sum(Landmark_RF$AUC)
Drug_Pathways_RF_AUC = sum(Drug_Pathways_RF$AUC)
TF_activity_RF_AUC = sum(TF_activity_RF$AUC)
Pathway_activity_RF_AUC = sum(Pathway_activity_RF$AUC)

WholeGenes_MLP_AUC = sum(WholeGenes_MLP$AUC)
Landmark_MLP_AUC = sum(Landmark_MLP$AUC)
Drug_Pathways_MLP_AUC = sum(Drug_Pathways_MLP$AUC)
TF_activity_MLP_AUC = sum(TF_activity_MLP$AUC)
Pathway_activity_MLP_AUC = sum(Pathway_activity_MLP$AUC)
