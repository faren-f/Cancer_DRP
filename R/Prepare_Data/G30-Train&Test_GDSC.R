...
GE = readRDS("Processed_Data/S41/GDSC_expresion_matrix.rds")
sen = readRDS("Processed_Data/S41/GDSC_sensitivity_matrix_AUC.rds")
IC50 = readRDS("Processed_Data/S41/GDSC_sensitivity_matrix_IC50.rds")
