...
#y = ifelse(y > thr_y,1,0)
#y = as.factor(y+1)

expr_i = expr[indeces_without_NA,]

## To check if there is any cor between response and edges
thr_cor = 0
...
cor_Xreduced_y = apply(X,2,function(x){abs(cor(x,as.numeric(y)))})
hist(cor_Xreduced_y,20)
