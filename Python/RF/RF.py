...
e = reverse_sorted_indices[0:500]
feature_list_selected = np.array(feature_list)[e.astype(int)]
...
# export_graphviz(tree, out_file = 'tree.dot', feature_names = feature_list_selected, rounded = True, precision = 1)
...
# model_small = RandomForestRegressor(n_estimators=200, max_depth = 3)
# model_small.fit(X_train, Y_train)
# # Extract the small tree
# tree_small = model_small.estimators_[5]
# # Save the tree as a png image
# export_graphviz(tree_small, out_file = 'small_tree.dot', 
#                 feature_names = feature_list_selected, rounded = True, precision = 1)
...
# feature_importances = [(feature, round(importance, 2)) for feature, importance in zip(feature_list_selected, importances)]
