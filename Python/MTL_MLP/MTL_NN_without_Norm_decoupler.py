...
for j in (range(0,1)):
    ...
    # Norm_X = Normalization(train_dataset.dataset.X[train_dataset.indices])
    ...
    for epoch in range(num_epochs):
        ...
        #cor_train, mse_train = evaluation(X_tr_norm,Y_tr_norm)
        #cor_test, mse_test = evaluation(X_te_norm,Y_te_norm)
