...
class MyGraphDataset():
    def __init__(self, root):
        ...
        path = os.path.join(root, 'edge_index_cellline_drug_NA.csv')
        edge_index_cellline_drug_NA = pd.read_csv(path, header = None, sep= ',')
        ...
        edge_index_cellline_drug_NA = np.array(edge_index_cellline_drug_NA)
        self.edge_index_cellline_drug_NA = torch.tensor(edge_index_cellline_drug_NA, dtype=torch.long)
